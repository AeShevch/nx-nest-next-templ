...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x05order\"\xd1\x01\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\rOrderResponse\x12\"\n" +
	"\x05order\x18\x01 \x01(\v2\f.order.OrderR\x05order\"I\n" +
	...
	"\x05limit\x18\x04 \x01(\x05R\x05limit2\xce\x02\n" +
	"\fOrderService\x12>\n" +
	...
	"\vUpdateOrder\x12\x19.order.UpdateOrderRequest\x1a\x14.order.OrderResponse\x12D\n" +
	"\vDeleteOrder\x12\x19.order.DeleteOrderRequest\x1a\x1a.order.DeleteOrderResponse\x12>\n" +
	"\tGetOrders\x12\x17.order.GetOrdersRequest\x1a\x18.order.GetOrdersResponseB\x15Z\x13order-service/protob\x06proto3"
...
var file_order_proto_depIdxs = []int32{
	...
	6, // 8: order.OrderService.GetOrders:input_type -> order.GetOrdersRequest
	...
	8, // 12: order.OrderService.DeleteOrder:output_type -> order.DeleteOrderResponse
	9, // 13: order.OrderService.GetOrders:output_type -> order.GetOrdersResponse
